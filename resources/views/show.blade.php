...
<div class="container mx-auto px-4">
    <div class="game-details border-b border-gray-800 pb-12 flex flex-col lg:flex-row">
        ...
        <div class="ml-0 lg:ml-12 lg:mr-64 mr-0">
            <h2 class="font-semibold text-4xl leading-tight lg:mt-0 mt-2">Last Of Us II</h2>
            <div class="text-gray-400">
                <span>Adventure, Horror</span>
                &middot;
                <span>Naughty Dog</span>
                &middot;
                <span>PS4</span>
            </div>
            <div class="flex flex-wrap items-center mt-8">
                ...
                <p class="lg:mt-12 mt-4">
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Facere, ex inventore debitis, ut maiores vel hic dicta deserunt eos maxime, doloremque accusamus fugiat neque vero expedita error incidunt alias ullam? Voluptatum sed fugit reiciendis cum, nostrum accusamus, nisi illum totam nemo dolore corrupti suscipit quod ea voluptate minima repellat?
                </p>
                <div class="mt-12">
